...
export class Contract {
  ...
  initialState(constructorContext, ...args) {
    ...
    state.setOperation('verifyTaxCompliance', new __compactRuntime.ContractOperation());
...
export function ledger(stateOrChargedState) {
  ...
  return {
    compliance_authority_vk: 0n,
    last_attestation_id: 0n,
    total_compliance_proofs: 0n,
    certified_tax_year: 0n,
    total_spent: spent,
