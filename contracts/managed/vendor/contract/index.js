...
export class Contract {
    ...
    this.circuits = {
      ...
      settleInvoice: (...args) => {
        ...
        if (!contextOrig || typeof contextOrig !== 'object' || contextOrig.currentQueryContext === undefined) {
          throw new __compactRuntime.CompactError('Circuit settleInvoice: invalid CircuitContext argument');
        }
        const context = { ...contextOrig, gasCost: __compactRuntime.emptyRunningCost() };
        const partialProofData = _ppd();
        const result = this._settleInvoice(context, partialProofData, ...args.slice(1));
  ...
  initialState(constructorContext, ...args) {
    ...
    state.setOperation('settleInvoice', new __compactRuntime.ContractOperation());
...
export function ledger(stateOrChargedState) {
  ...
  return {
    total_vendor_budget: 0n,
    total_settled: 0n,
    payer_authority_vk: 0n,
    last_settled_nullifier: 0n,
    total_spent: spent,
