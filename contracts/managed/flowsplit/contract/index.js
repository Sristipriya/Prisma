...
export class Contract {
    ...
    this.circuits = {
      ...
      executeFlowSplit: (...args) => {
        ...
        if (!contextOrig || typeof contextOrig !== 'object' || contextOrig.currentQueryContext === undefined) {
          throw new __compactRuntime.CompactError('Circuit executeFlowSplit: invalid CircuitContext argument');
        }
        const context = { ...contextOrig, gasCost: __compactRuntime.emptyRunningCost() };
        const partialProofData = _ppd();
        const result = this._executeFlowSplit(context, partialProofData, ...args.slice(1));
  ...
  initialState(constructorContext, ...args) {
    ...
    state.setOperation('executeFlowSplit', new __compactRuntime.ContractOperation());
